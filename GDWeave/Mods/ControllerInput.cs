...
public class ControllerInput {
    ...
    public class InputRemapButtonModifier : ScriptMod {
        public override bool ShouldRun(string path) => path == "res://Scenes/Singletons/OptionsMenu/input_remap_button.gdc";
